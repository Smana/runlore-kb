...
- Investigate and correct the Git authentication method configured in ArgoCD for the 'git@github.com:Aqemia/engineering.git' repository. This might involve updating an SSH key or token. (reversible=false)
