...
* **Creation**: Added [OpenBaoRaftQuorumAtRisk (pre-existing, occurrence #4) — false positive: single-node dev OpenBao where…](incidents/openbaoraftquorumatrisk-pre-existing-occurrence-4-false-positive-single-node-dev-openbao-where-f8c54dff.md).
