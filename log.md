...
* **Creation**: Added [Kustomization broken-kustomization ArtifactFailed — non-existent spec.path (this-path-does-not-exist)](incidents/kustomization-broken-kustomization-artifactfailed-non-existent-spec-path-this-path-does-not-exist-2c419b4f.md).
