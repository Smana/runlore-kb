...
* **Creation**: Added [LLMPlatformSemanticRouterDown — vllm-semantic-router never deployed; llm-platform Flux Kustomization is…](incidents/llmplatformsemanticrouterdown-vllm-semantic-router-never-deployed-llm-platform-flux-kustomization-is-1d81186e.md).
