...
* **Creation**: Added [Kustomization/security-openbao ArtifactFailed — pre-existing recurring source-controller PVC Multi-Attach during…](incidents/kustomization-security-openbao-artifactfailed-pre-existing-recurring-source-controller-pvc-multi-attach-during-3fde5d17.md).
