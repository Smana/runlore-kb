...
* **Creation**: Added [Kustomization eval-victim-broken ArtifactFailed — spec.path points to non-existent path in healthy source](incidents/kustomization-eval-victim-broken-artifactfailed-spec-path-points-to-non-existent-path-in-healthy-source-0604fa65.md).
