...
* **Creation**: Added [OpenBaoRaftQuorumAtRisk — false positive: FT=0 is the mathematical norm for this single-node dev OpenBao raft cluster](incidents/openbaoraftquorumatrisk-false-positive-ft-0-is-the-mathematical-norm-for-this-single-node-dev-openbao-raft-cluster-ff89cc55.md).
