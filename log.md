...
* **Creation**: Added [Kustomization/zitadel HealthCheckFailed — CNPG backup recovery failure blocks PostgreSQL, starving zitadel-init DB…](incidents/kustomization-zitadel-healthcheckfailed-cnpg-backup-recovery-failure-blocks-postgresql-starving-zitadel-init-db-5caba581.md).
