...
* **Creation**: Added [Harbor HelmRelease ValuesError: GCP Secret Manager denies access to 'harbor-oidc' secret, starving the…](incidents/harbor-helmrelease-valueserror-gcp-secret-manager-denies-access-to-harbor-oidc-secret-starving-the-e027412b.md).
