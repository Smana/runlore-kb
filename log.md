...
* **Creation**: Added [ImageGalleryUnavailable — fresh namespace bootstrap: pods started before S3 PodIdentityAssociation was ready,…](incidents/imagegalleryunavailable-fresh-namespace-bootstrap-pods-started-before-s3-podidentityassociation-was-ready-c7e9ae92.md).
