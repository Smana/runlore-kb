...
* **Creation**: Added [KubeSchedulerDown — false critical alert on newly provisioned EKS cluster (control plane scrape targets never…](incidents/kubeschedulerdown-false-critical-alert-on-newly-provisioned-eks-cluster-control-plane-scrape-targets-never-591d332f.md).
