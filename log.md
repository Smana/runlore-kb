...
* **Creation**: Added [HelmRelease headlamp-oauth2-proxy stuck: GCP Secret Manager secret missing, blocking ExternalSecret sync and pod startup](incidents/helmrelease-headlamp-oauth2-proxy-stuck-gcp-secret-manager-secret-missing-blocking-externalsecret-sync-and-pod-startup-76c340d5.md).
