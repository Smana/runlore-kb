...
- gitops_resource_status shows the Application/coder-dev is "OutOfSync" despite reporting "successfully synced (all tasks run)".
- pod_status shows the coder-c57dd8998-6xdxg pod is "Running ready=0/1", indicating the application is not becoming ready, likely due to incorrect or missing configuration.
